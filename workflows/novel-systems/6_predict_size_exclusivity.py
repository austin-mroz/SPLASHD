...
def main() -> None:
    ...
    splashd.plot.plot_cage_window_distribution(
    ...
    for solvent in solvent_db.get_entries():
        ...
        kde_overlap = splashd.predict.calculate_kde_overlap(
            cage_apertures=cage_apertures,
            solvent_sizes=solvent_sizes,
        )

        splashd.plot.plot_cage_distribution_with_solvent_means(
        ...
        splashd.plot.plot_cage_distribution_with_solvent_distributions(
            method_name=solvent.properties["aa_method"],
            cage_name="scrambled_CC313",
            cage_apertures=cage_apertures,
            solvent_name=solvent.key,

...
def main() -> None:
    ...
    for entry in solvent_db.get_entries():
        print(entry.key)
        aa_solvent = splashd.analyze_solvent_size.calculate_all_atom_steric_parameters(
        ...
        waa_solvent = splashd.analyze_solvent_size.calculate_weighted_all_atom_steric_parameters(
        ...
        updated_entry = atomlite.PropertyEntry(
            ...
            properties={
                ...
                # "aa_conformer_steric_parameter_dict": waa_solvent.aa_solvent.conformer_steric_parameters_dict,
